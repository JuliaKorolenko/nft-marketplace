      ...
      <div class="nft-price-section">
          <div>
              <div class="price-label">
                {{ price ? 'Current Price' : 'Preview Price' }}
              </div>
              <div class="price-value">
                  ...
                  {{ item.preview_price  }} ETH | {{ price }} ETH
              </div>
          </div>
      </div>
      <button class="buy-btn">{{ isConnected ? 'View details' : 'Connect Wallet' }}</button>
    </div>
  </div>
</template>
<style scoped>
